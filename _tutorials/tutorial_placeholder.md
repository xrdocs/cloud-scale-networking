...
An IMPROPER input regex string would match undesired statements. For example, consider a router configuration that includes an interface with ipv4 address 1.2.3.4 and an interface description 10203040  
