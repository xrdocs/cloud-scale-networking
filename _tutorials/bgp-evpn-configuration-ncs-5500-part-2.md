...
In the next post(https://xrdocs.io/cloud-scale-networking/tutorials/bgp-evpn-configuration-ncs-5500-part-3/), we will cover configuration of VLAN and stretching layer-2 bridging for that VLAN between the Leafs.  In next post's [Task-2](https://xrdocs.io/cloud-scale-networking/tutorials/bgp-evpn-configuration-ncs-5500-part-3/#task-2-configure-layer-2-interfaces-and-bridge-domain-on-leafs) and [Task-3](https://xrdocs.io/cloud-scale-networking/tutorials/bgp-evpn-configuration-ncs-5500-part-3/#task-3-configure-evpn-evi-on-leaf-1-leaf-2-for-vlan-10), VLAN configuration and service carving for Ethernet Segment is performed. The verification of Ethernet Segment after service carving is also covered in next post.
