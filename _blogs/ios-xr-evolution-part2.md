...
That is a mouthful of a description for SysDB but each word in there is important and collectively they define the concept and the power of SysDB. _Configuration_ and _operational data_ is a significant part of the router state and the IOS XR's SysDB is an advanced datastore to hold this data in a NOS.
